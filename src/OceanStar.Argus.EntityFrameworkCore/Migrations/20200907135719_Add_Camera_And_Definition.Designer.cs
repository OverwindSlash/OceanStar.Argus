...
namespace OceanStar.Argus.Migrations
{
    ...
    [Migration("20200907135719_Add_Camera_And_Definition")]
    partial class Add_Camera_And_Definition
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OceanStar.Argus.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OceanStar.Argus.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("OceanStar.Argus.Entities.Cameras.Camera", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OceanStar.Argus.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("OceanStar.Argus.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("OceanStar.Argus.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("OceanStar.Argus.Authorization.Roles.Role", b =>
                {
                    b.HasOne("OceanStar.Argus.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("OceanStar.Argus.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("OceanStar.Argus.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
