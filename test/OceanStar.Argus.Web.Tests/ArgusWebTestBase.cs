...
{
    public abstract class ArgusWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ArgusWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ArgusWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ArgusDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ArgusDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ArgusDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ArgusDbContext, Task<T>> func)
        {
            T result;
